...
<div class="parent">
        ...
        <div class="subMenu" style="max-height: {display ? 49 * tabChildren.length - 1 - (managers.length ? 0 : 48) : 0}px; width: {width}px; top: {height}px; left: {left}px; box-shadow: 0 0 {display ? "3px" : "0"} 0 #2d2d2d; border: {display ? "1px" : "0"} solid #2d2d2d; border-top: none;">
                <List>
